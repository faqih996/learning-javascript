...
var person = {
  ...
  weight: 90,
  height: 172,
  weightIdeal: function weightIdeal() {
    var heightMinus100 = this.height - 100;
    return heightMinus100 - heightMinus100 * 10 / 100;
  },
  needDiet: function needDiet() {
    var weightIdeal = this.weightIdeal();
    if (weightIdeal - 5 > this.weight) return "you need more protein, need more " + (weightIdeal - this.weight) + "kg";else if (weightIdeal + 5 < this.weight) return " you neeed a mayo diet, need reduce" + (this.weight - weightIdeal) + "kg";
    return "you are in a good shape";
  }
};
console.log(person.fullName());
console.log(person.weightIdeal());
console.log(person.needDiet()); // const countries = {
//   ID: {
